...
- [ ] **Phase 1: Project Skeleton & Deterministic Harness (M0)** - Python 3.12+, uv, strict typing, 100 Hz simulation clock, and deterministic test runner.
- [ ] **Phase 2: Data Contracts & Validation (M1)** - Strict Pydantic schemas for SensorFrame, GroundTruthFrame, Scenario, and evaluation contracts.
...
Plans:
- [ ] 01-01: Setup `uv` project, `pyproject.toml`, dependencies, and lint/type check toolchains.
- [ ] 01-02: Implement deterministic `SimulationClock` (100 Hz / 10 ms) and seed-isolated PRNG harness with unit tests.
...
Plans:
- [ ] 02-01: Implement `SensorFrame` and `GroundTruthFrame` contract models with strict null semantics.
- [ ] 02-02: Implement `Scenario`, `DecisionPayload`, and `EvaluationResult` contract models.
- [ ] 02-03: Create schema validation test suite asserting edge-case rejection and immutability.
...
|-------|----------------|--------|-----------|
| 1. Project Skeleton & Harness (M0) | 0/2 | Not started | - |
